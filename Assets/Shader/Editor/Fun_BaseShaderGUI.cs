...
namespace UnityEditor
{
    public abstract class Fun_BaseShaderGUI : ShaderGUI
    {
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            SetFoldoutState($"{m_HeaderStateKey}.SurfaceOptionsFoldout", m_SurfaceOptionsFoldout);
            ...
            SetFoldoutState($"{m_HeaderStateKey}.SurfaceInputsFoldout", m_SurfaceInputsFoldout);
            EditorGUILayout.EndFoldoutHeaderGroup();
            ...
            SetFoldoutState($"{m_HeaderStateKey}.AdvancedFoldout", m_AdvancedFoldout);
            EditorGUILayout.EndFoldoutHeaderGroup();
